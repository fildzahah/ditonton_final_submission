...
class SeriesTvRepositoryImpl implements TvSeriesRepository {
  ...
  @override
  Future<Either<Failure,String>> saveTvSeriesWatchlist(SeriesTvDetail series) async{
    try{
      final result = await localDataSource.insertTvSeriesWatchlist(SeriesTvTable.fromEntity(series));
      return Right(result);
  ...
  @override
  Future<Either<Failure,String>> removeTvSeriesWatchlist(SeriesTvDetail series) async{
    try{
      final result = await localDataSource.removeTvSeriesWatchlist(SeriesTvTable.fromEntity(series));
      return Right(result);
    } on DatabaseException catch (e){
      return Left(DatabaseFailure(e.message));
    }
